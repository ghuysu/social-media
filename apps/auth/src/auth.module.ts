  ...
  imports: [
    ...
    ConfigModule.forRoot({
      ...
      validationSchema: joi.object({
        ...
        JWT_EXPIRATION_ACCESS_TOKEN_USER: joi.string().required(),
        JWT_EXPIRATION_ACCESS_TOKEN_ADMIN: joi.string().required(),
        JWT_EXPIRATION_REFRESH_TOKEN_USER: joi.string().required(),
        JWT_EXPIRATION_REFRESH_TOKEN_ADMIN: joi.string().required(),
      }),
    }),
    JwtModule.register({
      global: true,
